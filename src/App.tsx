...
export default function App() {
  ...
  const getCategoryColor = (type: string) => {
    const map: Record<string, string> = { '交通': '#60A5FA', '美食': '#F97316', '景點': '#10B981', '住宿': '#A855F7' };
              ...
              {data.days.map((day: any, index: number) => (
                ...
                >
                  ...
                  <input
                    ...
                    className="w-full text-center bg-transparent outline-none text-xl font-bold handwriting"
                  />
                </div>
              ))}
              <button
